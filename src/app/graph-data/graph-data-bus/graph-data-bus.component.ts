...
@Component({
  selector: 'app-graph-data-bus',
  templateUrl: './graph-data-bus.component.html',
  styleUrls: ['./graph-data-bus.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class GraphDataBusComponent implements OnInit {
  public graph: Object;
  ...
  public filter: object[] = [
    { text: 'Trips', value: 7, field: 'trips' },
    { text: 'Routes', value: 8, field: 'routs' },
    { text: 'Passangers', value: 9, field: 'passangers' },
    { text: 'MaxSpeed', value: 10, field: 'maxSpeed' },
  ];
